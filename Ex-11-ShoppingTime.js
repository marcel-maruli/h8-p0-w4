...
function shoppingTime(memberId, money) {
  ...
  if (memberId === undefined || money === undefined){
      ...
      var barangharga = [["Sepatu Stacattu", 1500000],["Baju Zoro", 500000],["Baju H&N", 250000], ["Sweater Uniklooh", 175000],["Casing Handphone",50000]];
      var arr = [];
      var changeMoney = money
      for (var i = 0; i < barangharga.length; i++){
        if(money >= barangharga[i][1]){
          arr.push(barangharga[i][0]);
          changeMoney -= barangharga[i][1]
        }
        if (money < 50000){
